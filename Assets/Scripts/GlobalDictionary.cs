...
public class GlobalDictionary : MonoBehaviour
{
    ...
    private static List<Word> englishwords = new List<Word>() { 
        new Word("good", "goodd"), 
        new Word("bad","badd"), 
        new Word("black","blak"), 
        new Word("white","wite"),                                                      
        new Word("abandon","abbandon"), 
        new Word("ability","abiliti"), 
        new Word("able","abble")};


    public static bool UseChapter1Unit1 = true;
    private static List<Word> taksi1Enotita1 = new List<Word>() { 
        new Word("παπι", "παπη"), 
        new Word("πιτα", "πητα"), 
        new Word("πατατα", "παταττα"),
        new Word("τοπι", "τοπη"), 
        new Word("ελα", "ελλα"), 
        new Word("πανι", "πανη"), 
        new Word("παμε", "παμαι") };
    ...
    private static List<Word> taksi1Enotita2 = new List<Word>() { 
        new Word("εχει",  "εχι"), 
        new Word("οχι","οχη"), 
        new Word("παππούς", "παπούς"), 
        new Word("λίμνη", "λήμνη"), 
        new Word("ειναι", "εινε"), 
        new Word("ενα", "εννα"), 
        new Word("μια", "μηα"),
        new Word("μαμα", "μαμμα"),
    ...
    private static List<Word> taksi1Enotita3 = new List<Word>() { 
        new Word("απο", "απω"), 
        new Word("μύτη", "μήτη"), 
        new Word("γιατί", "γιατή"),
        new Word("σκηνή", "σκινή"), 
        new Word("μήλο", "μίλω"), 
        new Word("ζύμη", "ζήμη"), 
        new Word("ρινόκερος", "ρινόκαιρος"),
        new Word("κόκορας", "κόκκορας") };


    public static bool UseChapter1Unit4 = false;
    private static List<Word> taksi1Enotita4 = new List<Word>() { 
        new Word("αλεπού", "αλαιπού"), 
        new Word("φώς", "φος"), 
        new Word("φακός", "φακώς"), 
        new Word("ταξίδι", "ταξίδη"), 
        new Word("ψάχνω", "ψάχνο"), 
        new Word("ψιχάλα", "ψηχάλα"), 
        new Word("σκοτάδι", "σκοτάδη"),
        new Word("σωσίβιο", "σωσήβιο") };

    public static bool UseChapter1Unit5 = false;
    private static List<Word> taksi1Enotita5 = new List<Word>() { 
        new Word("μολύβι", "μολύβει"), 
        new Word("ψυγείο", "ψυγίο"), 
        new Word("παιδί", "πεδί"), 
        new Word("ανοίγω", "ανείγω"), 
        new Word("πίνακας", "πείνακας"), 
        new Word("οικόπεδο", "οικόπαιδο"), 
        new Word("ιππόκαμπος", "ιπόκαμπος"),
        new Word("ζωγραφίζω", "ζωγραφήζω") };

    public static bool UseChapter1Unit6 = false;
    private static List<Word> taksi1Enotita6 = new List<Word>() { 
        new Word("χιονάνθρωπος", "χιονάθρωπος"), 
        new Word("παπούτσι", "παπούστι"), 
        new Word("αγκάθι", "αγγάθι"), 
        new Word("κλειδί", "κλοιδί"), 
        new Word("αγγίζω", "αγκοίζω"), 
        new Word("νεράντζι", "νεράτζι"), 
        new Word("τζάκι", "ντζάκι"),
        new Word("αυτοκίνητο", "αυτοκήνιτο"), 
        new Word("αγγελία", "αγκελία"), 
        new Word("ευχή", "εφχη"), 
        new Word("ταχυδομείο", "ταχυδρομίο") };
